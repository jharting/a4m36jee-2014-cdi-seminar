...
/**
 * Cache for results of factorial operation. The cache is updated upon delivery of the
 * {@link FactorialComputationFinished} event. The cache state is guarded by read/write lock (EJB).
 *
